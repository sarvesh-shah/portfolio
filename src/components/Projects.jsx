...
import '../assets/styles/style.css'; // ✅ Make sure this exists

import {
  FaChartBar, FaProjectDiagram, FaBrain, FaReact, FaNodeJs, FaAws, FaDatabase, FaDocker, FaAngular, FaGithub,
  FaGitlab, FaGoogle, FaJava, FaJenkins, FaMicrosoft, FaPython, FaVuejs, FaLinux
} from 'react-icons/fa';
import {
...
const techIcons = {
  ...
  "CI/CD": <FaGitlab />, "GitLab": <FaGitlab />, "GitHub": <FaGithub />,
            ...
            <div className="tech-badges">
              {project.tech.map((t, i) => (
                <span key={i} className="tech-badge">
                  <span className="icon">{techIcons[t] || '🛠'}</span>
                  <span>{t}</span>
                </span>
              ))}
            </div>
